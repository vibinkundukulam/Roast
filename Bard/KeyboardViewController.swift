...
class KeyboardViewController: UIInputViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UIApplicationDelegate {
    ...
    func createInsultsWithoutName() {
        ...
        whatArray += [(NSMutableAttributedString(string: "Wacky, you always seems to be crying - a real nut job!", attributes: normalAttributes), NSAttributedString(string: "on Glenn Beck" , attributes: subtitleAttributes))]
        ...
        stupidArray += [(NSMutableAttributedString(string: "You're wrong on so many subjects!", attributes: normalAttributes), NSAttributedString(string: "on George Will" , attributes: subtitleAttributes))]
        ...
        worthlessArray += [(NSMutableAttributedString(string: "You never say anything good & never will.", attributes: normalAttributes), NSAttributedString(string: "on Karl Rove" , attributes: subtitleAttributes))]
        ...
        stupidArray += [(NSMutableAttributedString(string: "You're a dumb person who fails @ virtually everything you touch.", attributes: normalAttributes), NSAttributedString(string: "on Stuart Stevens" , attributes: subtitleAttributes))]
        liarArray += [(NSMutableAttributedString(string: "You're a total phony and con!", attributes: normalAttributes), NSAttributedString(string: "on Bob Vander Plaats" , attributes: subtitleAttributes))]
        stupidArray += [(NSMutableAttributedString(string: "Weak and totally conflicted people like you shouldn't be allowed on TV unless given an I.Q. test. Dumb as a rock!", attributes: normalAttributes), NSAttributedString(string: "on Rick Wilson" , attributes: subtitleAttributes))]
        whatArray += [(NSMutableAttributedString(string: "I don’t like your golf swing. Not athletic. Play you for charity!", attributes: normalAttributes), NSAttributedString(string: "on Samuel L. Jackson" , attributes: subtitleAttributes))]
        stupidArray += [(NSMutableAttributedString(string: "You're just plain dumb!", attributes: normalAttributes), NSAttributedString(string: "on CNN" , attributes: subtitleAttributes))]
        stupidArray += [(NSMutableAttributedString(string: "Why can't you get it right - it's really not that hard!", attributes: normalAttributes), NSAttributedString(string: "on CNN" , attributes: subtitleAttributes))]
        stupidArray += [(NSMutableAttributedString(string: "How stupid, how desperate!", attributes: normalAttributes), NSAttributedString(string: "on The New Hampshire Union Leader" , attributes: subtitleAttributes))]
        ...
        worthlessArray += [(NSMutableAttributedString(string: "I am happy to hear how badly you are doing. Becoming irrelevant!", attributes: normalAttributes), NSAttributedString(string: "on The New York Times" , attributes: subtitleAttributes))]
        ...
        liarArray += [(NSMutableAttributedString(string: "If you were legit, you would be doing far better!", attributes: normalAttributes), NSAttributedString(string: "on Politico" , attributes: subtitleAttributes))]
        ...
        liarArray += [(NSMutableAttributedString(string: "You have no power, but so dishonest!", attributes: normalAttributes), NSAttributedString(string: "on Politico" , attributes: subtitleAttributes))]
    ...
    func createInsultsWithName() {
        ...
        whatArray += [(NSMutableAttributedString(string: "Wacky \(name) who always seems to be crying - a real nut job!", attributes: normalAttributes), NSAttributedString(string: "on Glenn Beck" , attributes: subtitleAttributes))]
        ...
        stupidArray += [(NSMutableAttributedString(string: "\(name)'s wrong on so many subjects!", attributes: normalAttributes), NSAttributedString(string: "on George Will" , attributes: subtitleAttributes))]
        ...
        worthlessArray += [(NSMutableAttributedString(string: "\(name) never says anything good & never will.", attributes: normalAttributes), NSAttributedString(string: "on Karl Rove" , attributes: subtitleAttributes))]
        ...
        stupidArray += [(NSMutableAttributedString(string: "\(name)'s a dumb person who fails @ virtually everything they touch.", attributes: normalAttributes), NSAttributedString(string: "on Stuart Stevens" , attributes: subtitleAttributes))]
        liarArray += [(NSMutableAttributedString(string: "\(name)'s a total phony and con!", attributes: normalAttributes), NSAttributedString(string: "on Bob Vander Plaats" , attributes: subtitleAttributes))]
        stupidArray += [(NSMutableAttributedString(string: "Weak and totally conflicted people like \(name) shouldn't be allowed on TV unless given an I.Q. test. Dumb as a rock!", attributes: normalAttributes), NSAttributedString(string: "on Rick Wilson" , attributes: subtitleAttributes))]
        whatArray += [(NSMutableAttributedString(string: "I don’t like \(name)'s golf swing. Not athletic. Play them for charity!", attributes: normalAttributes), NSAttributedString(string: "on Samuel L. Jackson" , attributes: subtitleAttributes))]
        stupidArray += [(NSMutableAttributedString(string: "\(name) is just plain dumb!", attributes: normalAttributes), NSAttributedString(string: "on CNN" , attributes: subtitleAttributes))]
        stupidArray += [(NSMutableAttributedString(string: "Why can't \(name) get it right - it's really not that hard!", attributes: normalAttributes), NSAttributedString(string: "on CNN" , attributes: subtitleAttributes))]
        stupidArray += [(NSMutableAttributedString(string: "How stupid, how desperate!", attributes: normalAttributes), NSAttributedString(string: "on The New Hampshire Union Leader" , attributes: subtitleAttributes))]
        ...
        worthlessArray += [(NSMutableAttributedString(string: "I am happy to hear how badly \(name) is doing. Becoming irrelevant!", attributes: normalAttributes), NSAttributedString(string: "on The New York Times" , attributes: subtitleAttributes))]
        ...
        liarArray += [(NSMutableAttributedString(string: "If \(name) were legit, they would be doing far better!", attributes: normalAttributes), NSAttributedString(string: "on Politico" , attributes: subtitleAttributes))]
        ...
        liarArray += [(NSMutableAttributedString(string: "\(name) has no power, but so dishonest!", attributes: normalAttributes), NSAttributedString(string: "on Politico" , attributes: subtitleAttributes))]
