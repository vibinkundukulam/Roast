...
class KeyboardViewController: UIInputViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UIApplicationDelegate {
    ...
    func createInsultsWithoutName() {
        ...
        cluelessArray += [(NSMutableAttributedString(string: "Dopey - know nothing about me or my wealth. A waste!", attributes: normalAttributes), NSAttributedString(string: "on Anderson Cooper writer" , attributes: subtitleAttributes))]
    ...
    func createInsultsWithName() {
        ...
        embarassmentArray += [(NSMutableAttributedString(string: "\(name)'s a total embarassment to themselves and their family.", attributes: normalAttributes), NSAttributedString(string: "on Jeb Bush" , attributes: subtitleAttributes))]
        ...
        sleazyArray += [(NSMutableAttributedString(string: "Perv sleazebag.", attributes: normalAttributes), NSAttributedString(string: "on Anthony Weiner" , attributes: subtitleAttributes))]
        incompetentArray += [(NSMutableAttributedString(string: "\(name) should focus on all of the problems that they've caused with their ineptitude.", attributes: normalAttributes), NSAttributedString(string: "on Bill de Blasio" , attributes: subtitleAttributes))]
        ...
        talkingtoomuchArray += [(NSMutableAttributedString(string: "All \(name) does is talk, talk, talk, but they're incapable of doing anything.", attributes: normalAttributes), NSAttributedString(string: "on John McCain" , attributes: subtitleAttributes))]
        weakArray += [(NSMutableAttributedString(string: "\(name) choked like a dog. They're a choker.", attributes: normalAttributes), NSAttributedString(string: "on Mitt Romney" , attributes: subtitleAttributes))]
        ...
        crookedArray += [(NSMutableAttributedString(string: "\(name) wouldn't know the truth if it hit them in the face.", attributes: normalAttributes), NSAttributedString(string: "on Jeff Horwitz" , attributes: subtitleAttributes))]
        dummyArray += [(NSMutableAttributedString(string: "Liberal clown.", attributes: normalAttributes), NSAttributedString(string: "on Arianna Huffington" , attributes: subtitleAttributes))]
        dummyArray += [(NSMutableAttributedString(string: "Dope!", attributes: normalAttributes), NSAttributedString(string: "on Brit Hume" , attributes: subtitleAttributes))]
        ...
        weakArray += [(NSMutableAttributedString(string: "No focus, poor level of concentration!", attributes: normalAttributes), NSAttributedString(string: "on Ruth Marcus" , attributes: subtitleAttributes))]
        crookedArray += [(NSMutableAttributedString(string: "I think \(name) should have gone to prison for what they did.", attributes: normalAttributes), NSAttributedString(string: "on Steve Rattner" , attributes: subtitleAttributes))]
        weakArray += [(NSMutableAttributedString(string: "Not much power or insight!", attributes: normalAttributes), NSAttributedString(string: "on Joe Scarborough" , attributes: subtitleAttributes))]
        ...
        meanArray += [(NSMutableAttributedString(string: "Hater & racist.", attributes: normalAttributes), NSAttributedString(string: "on Tavis Smiley" , attributes: subtitleAttributes))]
        embarassmentArray += [(NSMutableAttributedString(string: "\(name) should be ashamed of themselves.", attributes: normalAttributes), NSAttributedString(string: "on Shep Smith" , attributes: subtitleAttributes))]
        dummyArray += [(NSMutableAttributedString(string: "Really dumb puppet.", attributes: normalAttributes), NSAttributedString(string: "on Marc Threaten (sic)" , attributes: subtitleAttributes))]
        ...
        weakArray += [(NSMutableAttributedString(string: "Irrelevant clown \(name) sweats and shakes nervously as they talk bull about me. Has zero cred.", attributes: normalAttributes), NSAttributedString(string: "on Karl Rove" , attributes: subtitleAttributes))]
        incompetentArray += [(NSMutableAttributedString(string: "\(name)'s a dumb person who fails @ virtually everything they touch.", attributes: normalAttributes), NSAttributedString(string: "on Stuart Stevens" , attributes: subtitleAttributes))]
        ...
        weakArray += [(NSMutableAttributedString(string: "I don’t like \(name)'s golf swing. Not athletic. Play them for charity!", attributes: normalAttributes), NSAttributedString(string: "on Samuel L. Jackson" , attributes: subtitleAttributes))]
        ...
        crookedArray += [(NSMutableAttributedString(string: "If \(name) were legit, they would be doing far better!", attributes: normalAttributes), NSAttributedString(string: "on Politico" , attributes: subtitleAttributes))]
        ...
        unpopularArray += [(NSMutableAttributedString(string: "\(name) is doing really poorly. They have gotten worse and worse over the years, and have lost almost all of their former allure!", attributes: normalAttributes), NSAttributedString(string: "on Vanity Fair" , attributes: subtitleAttributes))]
        talkingtoomuchArray += [(NSMutableAttributedString(string: "\(name) is bad at math. The good news is, nobody cares what they say anymore, especially me!", attributes: normalAttributes), NSAttributedString(string: "on The Wall Street Journal" , attributes: subtitleAttributes))]
        ...
        bestquotesArray += [(NSMutableAttributedString(string: "\(name) sucks and they are bad for U.S.A.", attributes: normalAttributes), NSAttributedString(string: "on Macy's stores" , attributes: subtitleAttributes))]
        ...
        loserArray += [(NSMutableAttributedString(string: "Loser.", attributes: normalAttributes), NSAttributedString(string: "on pretty much everybody" , attributes: subtitleAttributes))]
        incompetentArray += [(NSMutableAttributedString(string: "\(name) did an absolutely horrible job. \(name) should be ashamed of themselves.", attributes: normalAttributes), NSAttributedString(string: "on Rick Perry" , attributes: subtitleAttributes))]
        ...
        sleazyArray += [(NSMutableAttributedString(string: "\(name)'s a sleaze, in my book. \(name)'s a sleaze because they know the facts, and they know the facts well.", attributes: normalAttributes), NSAttributedString(string: "on Tom Llamas" , attributes: subtitleAttributes))]
        loserArray += [(NSMutableAttributedString(string: "What a stiff, what a stiff.", attributes: normalAttributes), NSAttributedString(string: "on Lindsey Graham" , attributes: subtitleAttributes))]
        uglyArray += [(NSMutableAttributedString(string: "I like the way \(name) used to look. I don’t like the way \(name) looks now. … they're a solid four. They went from an eight to a solid four.", attributes: normalAttributes), NSAttributedString(string: "on Nicolette Sheridan" , attributes: subtitleAttributes))]
        bestquotesArray += [(NSMutableAttributedString(string: "\(name) put on glasses so people will think they're smart. And it just doesn't work! You know people can see through the glasses.", attributes: normalAttributes), NSAttributedString(string: "on Rick Perry" , attributes: subtitleAttributes))]
        meanArray += [(NSMutableAttributedString(string: "\(name) never speaks well of me & yet when I saw them, they ran over like a child and wanted a picture.", attributes: normalAttributes), NSAttributedString(string: "on Juan Williams" , attributes: subtitleAttributes))]
        ...
        uglyArray += [(NSMutableAttributedString(string: "\(name)'s disgusting both inside and out. You take a look at them, a slob.", attributes: normalAttributes), NSAttributedString(string: "on Rosie O'Donnell" , attributes: subtitleAttributes))]
        ...
        uglyArray += [(NSMutableAttributedString(string: "Unattractive both inside and out.", attributes: normalAttributes), NSAttributedString(string: "on Arianna Huffington" , attributes: subtitleAttributes))]
        uglyArray += [(NSMutableAttributedString(string: "I’d look at \(name) right in that fat, ugly face of theirs, I’d say - ‘You’re fired.’", attributes: normalAttributes), NSAttributedString(string: "on Rosie O'Donnell" , attributes: subtitleAttributes))]
        ...
        talkingtoomuchArray += [(NSMutableAttributedString(string: "\(name) talks like a truck driver, doesn’t have their facts, they’ll say anything that comes to their mind.", attributes: normalAttributes), NSAttributedString(string: "on Rosie O'Donnell" , attributes: subtitleAttributes))]
        ...
        loserArray += [(NSMutableAttributedString(string: "Show me someone without an ego, and I'll show you a loser - having a healthy ego, or high opinion of yourself, is a real positive in life!", attributes: normalAttributes), NSAttributedString(string: "on the humble" , attributes: subtitleAttributes))]
        unpopularArray += [(NSMutableAttributedString(string: "Over \(name)'s life, they’ve been called a lot worse. Isn’t that right?", attributes: normalAttributes), NSAttributedString(string: "on Megyn Kelly" , attributes: subtitleAttributes))]
        poorArray += [(NSMutableAttributedString(string: "Some people aren’t meant to be rich. It’s a talent. Some people have a talent for piano. I just happen to have a talent for making money.", attributes: normalAttributes), NSAttributedString(string: "on the not rich" , attributes: subtitleAttributes))]
        ...
        embarassmentArray += [(NSMutableAttributedString(string: "\(name) is ashamed of their last name. They're a loser.", attributes: normalAttributes), NSAttributedString(string: "on Jeb Bush" , attributes: subtitleAttributes))]
        softArray += [(NSMutableAttributedString(string: "\(name) can't negotiate their way out of a paper bag.", attributes: normalAttributes), NSAttributedString(string: "on Jeb Bush" , attributes: subtitleAttributes))]
        crazyArray += [(NSMutableAttributedString(string: "I don’t think \(name)'s got the right temperament. I don’t think they've got the right judgment. A little bit of a maniac.", attributes: normalAttributes), NSAttributedString(string: "on Ted Cruz" , attributes: subtitleAttributes))]
        ...
        incompetentArray += [(NSMutableAttributedString(string: "Virtually incompetent.", attributes: normalAttributes), NSAttributedString(string: "on Cheri Jacobus" , attributes: subtitleAttributes))]
        talkingtoomuchArray += [(NSMutableAttributedString(string: "Once \(name) opened their mouth, people realized they were a complete & total dud!", attributes: normalAttributes), NSAttributedString(string: "on John Kasich" , attributes: subtitleAttributes))]
        ...
        talkingtoomuchArray += [(NSMutableAttributedString(string: "\(name) pretends to be smart, but they aren't. A dummy - an overrated clown!", attributes: normalAttributes), NSAttributedString(string: "on Charles Krauthammer" , attributes: subtitleAttributes))]
        ...
        loserArray += [(NSMutableAttributedString(string: "I easily beat \(name) on the golf course and will even more easily beat them now, in the world.", attributes: normalAttributes), NSAttributedString(string: "on Rand Paul" , attributes: subtitleAttributes))]
